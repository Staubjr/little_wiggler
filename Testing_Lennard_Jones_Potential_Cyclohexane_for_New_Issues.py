...
class molecule:
    ...
    def get_all_forces(self):
        ...
        # print(len(self.atoms[0].bonds))
        # print(self.atoms[0].bonds[0].k_bond, self.atoms[0].bonds[0].E0_bond)
                                
        # print("Bonds done:",self.atoms[0].atom_number, self.atoms[0].force)
        ...
        # print("Angles done:",self.atoms[0].atom_number, self.atoms[0].force)
        ...
        # print("Dihedrals done:",self.atoms[0].atom_number, self.atoms[0].force)                
        ...
        for specific_atom in self.atoms:
            ...
            for specific_lennard_jones_pair in lennard_jones.all_lennard_jones_pairs:
                ...
                # if specific_lennard_jones_pair.atom1.atom_number == int(16):
                #    if specific_lennard_jones_pair.atom2.atom_number == int(8):
                ...
                if specific_atom == specific_lennard_jones_pair.atom2:
                    ...
                    i +=1
        # print(self.atoms[0].atom_number, self.atoms[0].force)
        # sys.exit(20)
...
class bond:
    ...
    def bond_force(self):
        ...
        dU = 2 * self.k_bond * (mag(r_vec) - self.E0_bond) #### This previously had a value of 2 on it...
        Force_1 = dU * r_hat
        Force_2 = -1 * Force_1
...
def main():
    ...
    c_4 = atom(element = 'carbon', element_type = 'CC32A', atom_number = 4, y0 = -l0/2, z0 = -1)
